...
(function webpackUniversalModuleDefinition(root, factory) {
  if ((typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && (typeof module === "undefined" ? "undefined" : _typeof(module)) === 'object') module.exports = factory();else if (typeof define === 'function' && define.amd) define(factory);else if ((typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object') exports["Vue"] = factory();else root["Vue"] = factory();
})(this, function () {
  return (
    /******/
    function (modules) {
    ...
    function (module, exports, __webpack_require__) {
      ...
      exports.assertProp = function (prop, value) {
        ...
        if (!valid) {
          _.warn('Invalid prop: type check failed for ' + prop.path + '="' + prop.raw + '".' + ' Expected ' + formatType(expectedType) + ', got ' + formatValue(value) + '.');
      ...
      exports.checkComponent = function (el, options, hasAttrs) {
        ...
        if (tag === 'component') {
          ...
          return tag;
        } else if (hasAttrs && (tag = _.attr(el, 'component'))) {
          return tag;
        }
      };
      /**
    ...
    function (module, exports, __webpack_require__) {
      ...
      exports.isAndroid = inBrowser && navigator.userAgent.toLowerCase().indexOf('android') > 0; // Transition property/event sniffing
    ...
    function (module, exports, __webpack_require__) {
      ...
      strats.directives = strats.filters = strats.transitions = strats.components = strats.partials = strats.elementDirectives = function (parentVal, childVal) {
        ...
        if (components) {
          ...
          for (var key in components) {
            if (_.commonTagRE.test(key)) {
              _.warn('Do not use built-in HTML elements as component ' + 'name: ' + key);
            }
    ...
    function (module, exports, __webpack_require__) {
      ...
      var propBindingModes = config._propBindingModes; // internal directives

      var propDef = __webpack_require__(16);

      var componentDef = __webpack_require__(25); // terminal directives
      ...
      function compileElement(el, options) {
        var linkFn;
        var hasAttrs = el.hasAttributes(); // check terminal directives (repeat & if)
      ...
      function compileProps(el, propOptions) {
        ...
        while (i--) {
          ...
          name = options.name; // props could contain dashes, which will be
          ...
          if (/[A-Z]/.test(name)) {
            _.warn('You seem to be using camelCase for a component prop, ' + 'but HTML doesn\'t differentiate between upper and ' + 'lower case. You should use hyphen-delimited ' + 'attribute names. For more info see ' + 'http://vuejs.org/api/options.html#props');
          }
          ...
          value = el.getAttribute(name); // create a prop descriptor
          ...
          if (value !== null) {
            ...
            if (tokens) {
              ...
              prop.dynamic = true;
              prop.parentPath = textParser.tokensToExp(tokens); // check prop binding type.

              single = tokens.length === 1;
              literal = literalValueRE.test(prop.parentPath); // one time: {{* prop}}
        ...
        return function propsLinkFn(vm, el) {
          ...
          while (i--) {
            ...
            if (prop.raw === null) {
              ...
              vm._data[path] = options.type === Boolean ? false : options.hasOwnProperty('default') ? options.default : undefined;
              ...
              if (vm._context) {
                ...
                _.warn('Cannot bind dynamic prop on a root instance' + ' with no parent: ' + prop.name + '="' + prop.raw + '"');
              }
            } else {
              // literal, cast it and just set once
              value = options.type === Boolean && prop.raw === '' ? true : _.toBoolean(_.toNumber(prop.raw));
      ...
      function makeTerminalNodeLinkFn(el, dirName, value, options, def) {
        var descriptor = dirParser.parse(value)[0]; // no need to call resolveAsset since terminal directives
        // are always internal
      ...
      function compileDirectives(elOrAttrs, options) {
        var attrs = _.isPlainObject(elOrAttrs) ? mapToList(elOrAttrs) : elOrAttrs.attributes;
        var i = attrs.length;
        var dirs = [];
    ...
    function (module, exports, __webpack_require__) {
      ...
      function nodeToFragment(node) {
        ...
        if (_.isTemplate(node) && node.content instanceof DocumentFragment) {
          return node.content;
        } // script template
    ...
    function (module, exports, __webpack_require__) {
      ...
      module.exports = {
        bind: function bind() {
          ...
          var parentKey = prop.parentPath; // simple lock to avoid circular updates.
          ...
          this.parentWatcher = new Watcher(parent, parentKey, withLock(function (val) {
          ...
          if (prop.mode === bindingModes.TWO_WAY) {
            ...
            child.$once('hook:created', function () {
              self.childWatcher = new Watcher(child, childKey, withLock(function (val) {
    ...
    function (module, exports, __webpack_require__) {
      ...
      function Watcher(vm, expOrFn, cb, options) {
        ...
        this.deps = [];
        this.newDeps = []; // parse expression for getter/setter
      ...
      p.run = function () {
        if (this.active) {
          ...
          if (value !== this.value || _.isArray(value) || this.deep) {
    ...
    function (module, exports, __webpack_require__) {
      ...
      var config = __webpack_require__(3); // we have two separate queues: one for directive updates
      ...
      module.exports = {
        ...
        bind: function bind() {
          if (!this.el.__vue__) {
            ...
            _.replace(this.el, this.anchor); // check keep-alive options.
            ...
            this.keepAlive = this._checkParam('keep-alive') != null; // wait for event before insertion

            this.readyEvent = this._checkParam('wait-for'); // check ref
            ...
            this._pendingCb = this.ctorId = this.Ctor = null; // if static, build right now.
            ...
            _.warn('Do not create a component that only contains ' + 'a single other component - they will be mounted to ' + 'the same element and cause conflict. Wrap it with ' + 'an outer element.');
          }
        },
         ...
         */
        setComponent: function setComponent(value, data, afterBuild, afterTransition) {
         ...
         * the child vm.
         */
        resolveCtor: function resolveCtor(id, cb) {
          var self = this;
        ...
        unbind: function unbind() {
          this.invalidatePending();
          this.unbuild();
          this.unsetCurrent(); // destroy all keep-alive cached instances
      ...
      function transcludeTemplate(el, options) {
        ...
        if (!frag) {
          ...
          if (options.replace) {
            ...
            replacer.nodeType !== 1 || // when root node is <component>, is an element
            // directive, or has v-repeat, the instance could
            // end up having multiple top-level nodes, thus
            // becoming a block instance.
            tag === 'component' || _.resolveAsset(options, 'elementDirectives', tag) || replacer.hasAttribute(config.prefix + 'repeat')) {
              return frag;
            } else {
    ...
    function (module, exports, __webpack_require__) {
      ...
      exports.transition = __webpack_require__(38); // event listener directives

      exports.on = __webpack_require__(41);
      exports.model = __webpack_require__(42); // logic control directives

      exports.repeat = __webpack_require__(47);
      exports['if'] = __webpack_require__(48); // internal directives that should not be used directly
    ...
    function (module, exports, __webpack_require__) {
      ...
      p.leave = function (op, cb) {
        ...
        this.cancel = this.hooks && this.hooks.enterCancelled; // only need to do leaveNextTick if there's no explicit
        // js callback
    ...
    function (module, exports, __webpack_require__) {
      ...
      var uid = 0; // async component resolution states
      ...
      module.exports = {
        ...
        bind: function bind() {
          ...
          this.id = '__v_repeat_' + ++uid; // setup anchor nodes
          ...
          _.before(this.start, this.end); // check if this is a block repeat


          this.template = _.isTemplate(this.el) ? templateParser.parse(this.el, true) : this.el; // check other directives that need to be handled
          // at v-repeat level
        ...
        */
        resolveDynamicComponent: function resolveDynamicComponent(data, meta) {
          ...
          if (!Ctor.options) {
            _.warn('Async resolution is not supported for v-repeat ' + '+ dynamic component. (component: ' + id + ')');
        ...
        update: function update(data) {
          if (this.componentId) {
            ...
            if (state === UNRESOLVED) {
              this.pendingData = data; // once resolved, it will call realUpdate
        ...
        diff: function diff(data, oldVms) {
          ...
          var obj, raw, vm, i, l, primitive; // First pass, go through the new Array and fill up
          ...
          for (i = 0, l = vms.length; i < l; i++) {
            vm = vms[i]; // this is the vm that we should be after

            targetPrev = vms[i - 1];
            prevEl = targetPrev ? targetPrev._staggerCb ? targetPrev._staggerAnchor : targetPrev._blockEnd || targetPrev.$el : start;
        ...
        build: function build(data, index, needCache) {
          ...
          var type = _typeof(raw);

          var dir = this;

          if (this.rawType === 'object' && (type === 'string' || type === 'number')) {
            vm.$watch(alias || '$value', function (val) {
              if (dir.filters) {
                _.warn('You seem to be mutating the $value reference of ' + 'a v-repeat instance (likely through v-model) ' + 'and filtering the v-repeat at the same time. ' + 'This will not work properly with an Array of ' + 'primitive values. Please use an Array of ' + 'Objects instead.');
              }
        ...
        uncacheVm: function uncacheVm(vm) {
          var data = vm._raw;
          var idKey = this.idKey;
          var index = vm.$index; // fix #948: avoid accidentally fall through to
        ...
        _preProcess: function _preProcess(value) {
          ...
          var type = this.rawType = _typeof(value);
        ...
        remove: function remove(vm, index, total, inDoc) {
          if (vm._staggerCb) {
            ...
            vm._staggerCb = null; // it's not possible for the same vm to be removed
      ...
      module.exports = {
        bind: function bind() {
          ...
          if (!el.__vue__) {
            ...
            this.linker = compiler.compile(this.template, this.vm.$options, true);
          } else {
            this.invalid = true;
    ...
    /***/
    function (module, exports, __webpack_require__) {
      var _ = __webpack_require__(1); // This is the elementDirective that handles <content>
      ...
      module.exports = {
        bind: function bind() {
          var vm = this.vm;
          var host = vm; // we need find the content context, which is the
      ...
      function extractFragment(nodes, parent, main) {
        ...
        for (var i = 0, l = nodes.length; i < l; i++) {
          var node = nodes[i]; // if this is the main outlet, we want to skip all
    ...
    function (module, exports, __webpack_require__) {
      ...
      var cache = new Cache(1000); // v-partial reuses logic from v-if
      ...
      module.exports = {
        ...
        insert: function insert(id) {
          ...
          if (partial) {
            var frag = templateParser.parse(partial, true); // cache partials based on constructor id.

            var cacheId = (this.vm.constructor.cid || '') + partial;
            var linker = this.compile(frag, cacheId); // this is provided by v-if
    ...
    function (module, exports, __webpack_require__) {
      ...
      exports._init = function (options) {
        ...
        this._unlinkFn = null; // context: the scope in which the component was used,
        // and the scope in which props and contents of this
        // instance should be compiled in.

        this._context = options._context || options._parent; // push self into parent / transclusion host
        ...
        this._reused = false;
        this._staggerOp = null; // merge options.

        options = this.$options = mergeOptions(this.constructor.options, options, this); // initialize data as empty object.
        // it will be filled up in _initScope().

        this._data = {}; // initialize data observation and scope inheritance.
      ...
      exports._initData = function () {
        ...
        if (optionsData) {
          ...
          for (var prop in propsData) {
            if (!optionsData.hasOwnProperty(prop) || propsData[prop] !== undefined) {
    ...
    function (module, exports, __webpack_require__) {
      ...
      exports._compile = function (el) {
        ...
        if (options._linkFn) {
          ...
          this._initElement(el); // root is always compiled per-instance, because
          // container attrs and props can be different every time.


          var rootUnlinkFn = compiler.compileAndLinkRoot(this, el, options); // compile and link the rest
          ...
          var contentUnlinkFn = linker ? linker(this, el) : compiler.compile(el, options)(this, el, host);
      ...
      exports._initElement = function (el) {
        if (el instanceof DocumentFragment) {
          ...
          this._blockEnd = el.lastChild; // set persisted text anchors to empty
      ...
      exports._cleanup = function () {
        ...
        this._data = this._watchers = this.$el = this.$parent = this.$root = this.$children = this._directives = null; // call the last hook...
    ...
    function (module, exports, __webpack_require__) {
      ...
      function Directive(name, el, vm, descriptor, def, host) {
        ...
        this.filters = descriptor.filters; // private
    ...
    function (module, exports, __webpack_require__) {
      ...
      exports._resolveComponent = function (id, cb) {
        ...
        _.assertAsset(factory, 'component', id); // async component factory
